...
class Linear_Model():
    def __init__(self, A, b, c, min_or_max, constr_signs, verbose):
        self.A = A
        self.b = b
        self.c = c
    ...
    def get_Tableau_Phase1(self):
        ...
        # Bulding starting tableau blocks
    ...
    def pivoting_operation(self, tableau, row_index, col_index):
        # The element at index (i,j) will be the pivot element and row i will be the pivoting row.
        # Divide the row i by the pivot to make it equal to 1. Then subtract c*(row i) from other
        # rows, where c is the coefficient required to make that row equal to 0 at the column j.
    ...
    def simplex(self, tableau):
        ...
        while True:
            ...
            if (not self.bounded):
                ...
                print("\nThere are no positive elements in the pivoting column")
                print("\nProblem unbounded; No solution.")
                return
            ...
            if self.verbose:
                ...
                print("Pivot Column:", col_index)
                print("Pivot Element: ", np.round(pivot, 3))
    ...
    def remove_artificial_variables(self, tableau):
        ...
        # Once removed the AV in the basis (if any) we can delete the AV columns from the tableau
    ...
    def get_Tableau_Phase2(self, tableau):
        ...
        if self.verbose:
            print("Tableau ready for the Phase 2")
            self.printTableau(tableau)
            print("-"*70)
            print("-"*30 + " PHASE 2 " + "-"*30)
